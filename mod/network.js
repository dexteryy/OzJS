 ...
 */
oz.def("network", ["oop"], function(oop, require, exports){
    ...
    var ajax = function(s){
        ...
        function httpSuccess(r) {
            try {
                return !r.status && location.protocol == "file:" || ( r.status >= 200 && r.status < 300 ) || r.status == 304 || r.status == 1223 || $.browser.safari && r.status == undefined;
            } catch(e){}
            return false;
        }
